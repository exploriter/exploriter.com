...
- Smoothie with _raw milk_ (Tier 1), _raw eggs_ (Tier 1), _kefir_ (Tier 1), _bone broth_ (Tier 2), _papaya_ (Tier 3), _dates_ (Tier 3)
- Fresh squeezed _orange juice_ (Tier 3)

### Snack

- _Saurkraut_ (Tier 4)
- _Raw oysters_ (Tier 2)

### Meal

- _Steak_ (Tier 2), _eggs_ (Tier 1), _butter_ (Tier 2), _fresh herbs_ (Tier 4)
- Pre-cooked _potatoes_ (Tier 4) with _sour cream_ (Tier 2)
...
- Warm _raw milk_ (Tier 1) with _honey_ (Tier 1) and mineral salts
