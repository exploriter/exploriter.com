...
- Smoothie with _raw milk_ (Tier 1), _raw eggs_ (Tier 1), _kefir_ (Tier 1), _bone broth_ (Tier 2), _paypaya_ (Tier 3), _dates_ (Tier 3)
...
- Pre-cooked _potatoes_ (Tier 4) with sour cream (Tier 2)
